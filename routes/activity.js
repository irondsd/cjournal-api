...
router.post('/:id/activity', (req, res) => {
    ...
    if (req.params.task_id && !req.params.time_ended) {
        ...
        sql = `insert into activity(users_id, activity_type, time_started, duration, data, time_ended) values 
            ('${req.params.id}', '${req.body.activity_type}', '${req.body.time_started}', '${req.body.duration}', "${req.body.data}", '${req.body.time_ended}')`
    }
        ...
        sql = `insert into activity(users_id, activity_type, time_started, duration, data, task_id, time_ended) values 
            ('${req.params.id}', '${req.body.activity_type}', '${req.body.time_started}', '${req.body.duration}', "${req.body.data}", '${req.body.task_id}', '${req.body.time_ended}')`
    }
    else {
